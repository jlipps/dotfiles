...
if !exists('g:vscode')
    ...
    Plug 'neoclide/coc.nvim', {'branch': 'release', 'do': ':CocInstall coc-java coc-omnisharp coc-tsserver coc-pyright coc-eslint coc-deno coc-svelte coc-css coc-prettier'}  " code completion based on lang server
